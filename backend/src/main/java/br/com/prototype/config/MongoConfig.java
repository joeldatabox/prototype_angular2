package br.com.prototype.config;

import br.com.prototype.repository.impl.PrototypeRepositoryImpl;
 ...
 */
@Configuration
@EnableMongoRepositories(basePackages = "br.com.prototype.repository", repositoryBaseClass = PrototypeRepositoryImpl.class)
